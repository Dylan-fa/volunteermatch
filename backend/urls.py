...
urlpatterns = [
    ...
    path('api/charity-contact-information/<int:reg_number>/<int:suffix>/', views.charity_contact_information, name='charity_contact_information'),
    path('api/charity-contact-information/<int:reg_number>/', views.charity_contact_information, name='charity_contact_information_no_suffix'),
    ...
    path('api/auth/verify-organization/', views.verify_organization, name='verify-organization'),
